...
- [ ] Implement Altar (NFT staking)
- [ ] Create Mine (LP staking)
- [ ] Build City Hall (basic functionality)
- [ ] Implement basic Gold generation system

### 2.2 Local Economy
- [ ] Create Home building system
- [ ] Implement Food production (Farms/Mills)
...
### 3.1 Treasury System
- [ ] Implement Gold donation system
- [ ] Create city treasury contract
- [ ] Add tier progression system
- [ ] Implement basic city upgrades
...
1. Enhance world map implementation
2. Develop city selection system
3. Create NFT verification for city access
4. Implement basic city view
5. Develop Altar contract for NFT staking
