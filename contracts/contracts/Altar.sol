...
contract Altar is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function unstake(address collection, uint256 tokenId) external nonReentrant {
        ...
        (GridBuildings.GridBuildingType buildingType, uint8 level, uint256 lastUpgradeTime, uint256 lastRechargeTime, uint256 lastCollectionTime, ) = gridBuildings.buildings(msg.sender, buildingId);
